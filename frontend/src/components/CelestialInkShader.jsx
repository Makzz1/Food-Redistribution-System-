  ...
  useEffect(() => {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        // REDUCE SPEED: changed from 0.1 to 0.04
        float t     = iTime * 0.04;
        ...
        // ink patterns
        // INCREASE SMOKE SIZE/WIDTH: changed from 3.0 to 1.5, and 6.0 to 3.0
        float pattern = fbm(p * 1.5 + t);
        pattern -= fbm(p * 4.0 - t * 0.5) * 0.3;
        pattern += ripple * 0.5;

        // color mix for an even lighter sky blue
        vec3 c1 = vec3(0.4, 0.7, 0.95);  // Lighter deep sky blue
        vec3 c2 = vec3(0.7, 0.85, 1.0);  // Very light sky blue
        vec3 highlight = vec3(1.0, 1.0, 1.0); // White smokes
